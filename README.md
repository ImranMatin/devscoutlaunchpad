...
- **🏠 Landing Page** — Public home page with hero banner image, hero section, feature grid, FAQ, and footer with company/connect links. Navbar with persistent links to Home, About, Contact, and Get Started.
